...
//
//
#ifndef lappdPMThit_h
#define lappdPMThit_h 1
...
class lappdPMThit : public G4VHit
{
  public:
 
    //lappdPMThit();
    lappdPMThit(const G4Step* aStep);
    virtual ~lappdPMThit();
    lappdPMThit(const lappdPMThit &right);

    const lappdPMThit& operator=(const lappdPMThit &right);
    G4int operator==(const lappdPMThit &right) const;
...
typedef G4THitsCollection<lappdPMThit> lappdPMThitsCollection;

extern G4Allocator<lappdPMThit> lappdPMThitAllocator;

inline void* lappdPMThit::operator new(size_t){
    return (void *) lappdPMThitAllocator.MallocSingle();
}

inline void lappdPMThit::operator delete(void *aHit){
  lappdPMThitAllocator.FreeSingle((lappdPMThit*) aHit);
}
