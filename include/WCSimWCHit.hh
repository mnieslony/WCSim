...
class WCSimWCHit : public G4VHit
{
 ...
 public:
  ...
  //void SetLAPPDID       (G4int lappd)               { lappdID = lappd; };
  ...
  void AddStripPosition(G4ThreeVector pos)
  {
    //position.insert(std::pair<i,G4ThreeVector> (i, pos) );
   position.push_back(pos);
  }

  //---------------------------
  G4int         GetTubeID()     { return tubeID; }
  //G4int         GetLAPPDID()    { return lappdID; };
