...
void WCSimWCTriggerBase::Digitize()
{
  ...
  //DigitsCollection = new WCSimWCTriggeredDigitsCollection ("/WCSim/glassFaceWCPMTLAPPDS",collectionName[0]);
  //DigitsCollection = new WCSimWCTriggeredDigitsCollection ("/WCSim/glassFaceWCONLYLAPPDS",collectionName2[0]);
  ...
  :G4VDigi()
{
  ...
  //totalPelappd = right.totalPelappd;
}
