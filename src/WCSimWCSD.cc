...
{ 
  ...
  if(collectionName[0]!= "ANNIEp2-glassFaceWCONLYLAPPDS"){
    WCIDCollectionName = fdet->GetIDCollectionName();
  }
  if(collectionName[0]=="ANNIEp2-glassFaceWCONLYLAPPDS"){
    WCIDCollectionName = fdet->GetIDCollectionName2();
  }
  // G4cout<<"WCSimWCSD process hits-- collectionName[0]= "<<collectionName[0]<<G4endl;
