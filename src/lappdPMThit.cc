...
G4Allocator<lappdPMThit> lappdPMThitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

//lappdPMThit::lappdPMThit() : fPmtNumber(-1),fPhysVol(0),fDrawit(false) {} // not used. fPhotons(0),

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

lappdPMThit::lappdPMThit(const G4Step* aStep){
...
lappdPMThit::~lappdPMThit() {} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

lappdPMThit::lappdPMThit(const lappdPMThit &right) : G4VHit()
{
  fHitID=right.fHitID;
...
const lappdPMThit& lappdPMThit::operator=(const lappdPMThit &right){
  fHitID=right.fHitID;
  fTrackID=right.fTrackID;
  fParentID=right.fParentID;
  fPmtNumber=right.fPmtNumber;
...
G4int lappdPMThit::operator==(const lappdPMThit &right) const{
  return (fHitID==right.fHitID);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void lappdPMThit::Draw(){
