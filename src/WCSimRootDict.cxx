...
#define R__DICTIONARY_FILENAME dIanniedIappdIusersdIedrakopodIWCSim_ANNIEdIsrcdIWCSimRootDict
...
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh"
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootGeom.hh"
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimPmtInfo.hh"
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDInfo.hh"
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDpulse.hh"
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDpulseCluster.hh"
#include "/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimEnumerations.hh"
...
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh",
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootGeom.hh",
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimPmtInfo.hh",
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDInfo.hh",
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDpulse.hh",
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDpulseCluster.hh",
"/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimEnumerations.hh",
0
    };
    static const char* includePaths[] = {
"/grid/fermiapp/products/larsoft/root/v6_06_08/Linux64bit+2.6-2.12-e10-nu-debug/include",
"/annie/app/users/edrakopo/WCSim_ANNIE/include",
"/annie/app/users/edrakopo/WCSim_ANNIE/../shared/include",
"/grid/fermiapp/products/larsoft/root/v6_06_08/Linux64bit+2.6-2.12-e10-nu-debug/include",
"/annie/app/users/edrakopo/build_WCSim_ANNIE/",
0
    };
...
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootCherenkovDigiHit;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootCherenkovHit;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootCherenkovHitTime;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootTrack;
class __attribute__((annotate(R"ATTRDUMP(WCSimRootEvent Header)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootEventHeader;
class __attribute__((annotate(R"ATTRDUMP(WCSimRootEvent structure)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootTrigger;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootEvent;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimRootPi0;
class __attribute__((annotate(R"ATTRDUMP(WCSimRootEvent structure)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootGeom.hh")))  WCSimRootGeom;
class __attribute__((annotate(R"ATTRDUMP(WCSimPMT structure)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootGeom.hh")))  WCSimRootPMT;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimPmtInfo.hh")))  WCSimPmtInfo;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDInfo.hh")))  WCSimLAPPDInfo;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimRootEvent.hh")))  WCSimEnumerations;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDpulse.hh")))  WCSimLAPPDpulse;
class __attribute__((annotate("$clingAutoload$/annie/app/users/edrakopo/WCSim_ANNIE/include/WCSimLAPPDpulseCluster.hh")))  WCSimLAPPDpulseCluster;
)DICTFWDDCLS";
