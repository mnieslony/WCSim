...
:myAction(pointerToAction)
{
  ...
  //T. Akiri: Addition of laser, M.Nieslony: Addition of antinu, led
  genCmd->SetGuidance(" Available generators : muline, gun, laser, gps, beam, antinu, led");
  genCmd->SetParameterName("generator",true);
  genCmd->SetDefaultValue("beam");	// previously muline
  //T. Akiri: Addition of laser, M.Nieslony: Addition of antinu, genie
  genCmd->SetCandidates("muline gun laser gps beam antinu led");
