...
if (Vis_Choice == "RayTracer"){
 ...
 // ---------------------------------------------------------
  ...
  //G4cout<<" testtttttttt: "<<WCIDCollectionName<<","<<WCIDCollectionName2<<G4endl;
 ...
 // logicWCPMT->GetDaughter(0),physiCapPMT is the glass face. If you add more 
  ...
  for(G4double i = 0; i < WCPMTperCellHorizontal; i++){
    for(G4double j = 0; j < WCPMTperCellVertical; j++){
	  ...
	  G4cout<<"PMT positions in barrel: "<<WCIDRadius<<","<< -barrelCellWidth/2.+(i+0.5)*horizontalSpacing <<","<<(-barrelCellHeight/2.+(j+0.5)*verticalSpacing)*zflip <<G4endl;
  ...
  //G4cout<<"Barrel: WCPMTperCellVertical= "<<WCPMTperCellVertical<<"  WCPMTperCellHorizontal= "<< WCPMTperCellHorizontal<<"\n";
