...
lappdPMTSD::lappdPMTSD(G4String name)
  : G4VSensitiveDetector(name),fPMTHitCollection(0)
{
  collectionName.insert("lappdpmtHitCollection");
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

lappdPMTSD::~lappdPMTSD() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void lappdPMTSD::Initialize(G4HCofThisEvent* hitsCE){
  fPMTHitCollection = new lappdPMThitsCollection(SensitiveDetectorName,collectionName[0]);
...
G4bool lappdPMTSD::ProcessHits(G4Step* ,G4TouchableHistory* ){
  return false;	
...
G4bool lappdPMTSD::ProcessHits_PhotonHit(const G4Step* aStep, G4TouchableHistory* ){
...
/*  //Find the correct hit collection
  ...
  if(hit==NULL){//this pmt wasnt previously hit in this event
    hit = new lappdPMThit(); //so create new hit
...
// --------------------------------------------------------
     lappdPMThit* hit = new lappdPMThit(aStep); // create new hit
     hit->SetHitID(nhit);
     nhit++;
     hit->SetPMTNumber(pmtNumber);
     hit->SetPMTPhysVol(physVol);
...
void lappdPMTSD::EndOfEvent(G4HCofThisEvent* ) {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void lappdPMTSD::clear() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void lappdPMTSD::DrawAll() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void lappdPMTSD::PrintAll() {}
